...
**版本管理**：本项目采用动态版本管理，版本号基于Git标签自动生成（使用 `setuptools_scm`），确保版本与代码状态保持一致。
...
本项目使用 **scikit-build-core** 作为构建系统，支持通过 pip 直接安装：
