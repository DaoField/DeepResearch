...
1. 确保 Python 版本满足要求（>=3.10,<4.0）
2. 安装 DeepResearch（详见[部署文档](../deployment/deployment.md)）
3. 配置 LLM 和搜索工具的 API 密钥（详见[部署文档](../deployment/deployment.md)）
...
**输入**：
```bash
deepresearch "请介绍阿里巴巴公司的电商零售业务板块，并分析其未来3-5年的发展前景，重点关注行业竞争视角。"
```
